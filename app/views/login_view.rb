class LoginView < UIView
  ...
  def initialize(parent_view)
    initWithFrame(parent_view.bounds).tap do
      ...
      @user_field.layer.cornerRadius = 2.0
      @user_field.clipsToBounds = true
      ...
      @password_field.layer.cornerRadius = 2.0
      @password_field.clipsToBounds = true
      paddingView = UIView.alloc.initWithFrame [[0, 0], [10, 50]]
      ...
      login_button.layer.cornerRadius = 2.0
